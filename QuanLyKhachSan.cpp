...
struct Customer		//Khai b�o 'c�u tr�c th�ng tin kh�ch h�ng 
{
	char Name[20];	//Ten
	char ID[15];	//CMND 
	int Year;		//Nam Sinh 
...
struct Employee		//Khai b�o 'c�u tr�c th�ng tin nh�n vi�n kh�ch san.
{
	char Name[20];	
	char ID[15];	
	int Year;		
...
struct Inroom		//khai b�o 'c�u tr�a th�ng tin ph�ng trong kh�ch san.
{
	Customer Cus;		//khai b�o Customer Khach de truy cap thong tin khach hang
	//init();
...
public:	//Cac chuc nang chinh:
	...
	//Th�ng tin ph�ng trong khach san:
	Inroom Room[N];	
	...
	void Hire(Employee emp);		//h�m thu� nh�n vi�n moi
	...
	void Rent(Customer x,int to);	//h�m dang ky kh�ch thu� ph�ng
	void Pay(int from);				//h�m thanh to�n tien phong
	void Change();					//h�m doi ph�ng cho kh�ch
	...
	//Cac loai dich vu:
	void Complain(int i);			//ham "than phi�n`": d�ng khi c� c�c v�n de xay ra voi phong nhu chuyen phong,...
	void Maintain(int i);			//ham "bao tri": d�ng khi bao tr� ph�ng
	...
	void ResetInfo(int i);			//xoa toan bo thong tin hien tai cua ph�ng
